...
namespace Todos
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private void BtnGetAll_Click(object sender, RoutedEventArgs e)
        {
            ...
            using (var statement = db.Prepare("SELECT Id, Title, Details, Date FROM TodoItem WHERE Title LIKE ? OR Details LIKE ? OR Date LIKE ?"))
            {
                ...
                {
                    str += "Id:" + list[j].ID + ";  Title:" + list[j].title + ";  Details:" + list[j].description + ";  Date:" + list[j].date + "\n";
                }
